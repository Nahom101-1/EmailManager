    ...
    <div className="list-row" style={{ alignItems: "center" }}>
      {icon && (
        <span
          ...
          style={{ color: danger ? "var(--st-error)" : "var(--ink-2)" }}
        >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div
          className="row-title"
          style={{ fontSize: 12.5, color: danger ? "var(--st-error)" : "var(--ink)" }}
        >
          {title}
        </div>
    ...
    <div className="page fade-in" style={{ maxWidth: 860 }}>
      ...
      <div className="grid" style={{ gap: 18 }}>
        ...
        <Card>
          <div className="card-head">
            <h3 className="center gap8">
              <Icon name="db" size={15} className="muted" />
              Local data
            </h3>
          ...
          <div className="list">
            <Row
              ...
              desc="SQLite file storing all scanned metadata"
            >
            ...
            <Row
              ...
              desc="Permanently remove all scanned metadata"
              danger
            >
              <ResetDataButton />
            </Row>
        ...
        <Card>
          <div className="card-head">
            <h3 className="center gap8">
              <Icon name="shield" size={15} className="muted" />
              Security
            </h3>
          </div>
          <div className="list">
            <Row
              ...
              desc={
                encryptionConfigured
                  ? "Tokens encrypted at rest (AES via crypto-js)"
                  : "Using dev fallback key — set ENCRYPTION_SECRET"
              }
            >
              <span className={"badge " + (encryptionConfigured ? "active" : "warn")}>
                {encryptionConfigured ? "Enabled" : "Dev key"}
              </span>
            </Row>
            <Row
              icon="key"
              title="Rotate local encryption secret"
              desc="Re-encrypt stored tokens with a new key"
            >
        ...
        <Card>
          <div className="card-head">
            <h3 className="center gap8">
              <Provider provider="google" size="sm" />
              Google
            </h3>
          </div>
          <div className="list">
            ...
            >
              <span className={"badge " + (googleConfigured ? "active" : "warn")}>
                <span className="dot" />
            ...
            {googleProvider ? (
              <Row
                icon="mail"
                title={googleProvider.email}
                desc="Read-only Gmail · token stored locally"
              >
              ...
              <Row
                ...
                desc="Connect from the Connect page"
              />
            )}
          </div>
        </Card>
        ...
        <Card>
          <div className="card-head">
            <h3 className="center gap8">
              <Icon name="mail" size={15} className="muted" />
              IMAP
            </h3>
          </div>
          <div className="list">
        ...
        <Card>
          <div className="card-head">
            <h3 className="center gap8">
              <Icon name="bolt" size={15} className="muted" />
              Developer
            </h3>
            <span className="sub">Environment checks</span>
          </div>
          <div className="card-pad grid" style={{ gap: 0 }}>
            <div className="kv">
              <span className="k">App version</span>
              <span className="v mono">LifeOS v{pkg.version}</span>
            </div>
            <div className="kv">
              <span className="k">Token encryption</span>
              <span className="v">
                <span className={"badge " + (encryptionConfigured ? "active" : "warn")}>
                  <span className="dot" />
                  {encryptionConfigured ? "Configured" : "Dev key"}
                </span>
              </span>
            </div>
            <div className="kv">
              <span className="k">Google OAuth client</span>
              <span className="v">
                <span className={"badge " + (googleConfigured ? "active" : "warn")}>
                  <span className="dot" />
                  {googleConfigured ? "Configured" : "Missing"}
            ...
            <div className="kv">
              <span className="k">Cloud AI</span>
              <span className="v">
                <span className={"badge " + (cloudAiConfigured() ? "active" : "idle")}>
                  <span className="dot" />
                  {cloudAiConfigured() ? "Key set" : "Demo mode"}
                </span>
              </span>
            </div>
            <div className="kv">
              <span className="k">Google redirect URI</span>
