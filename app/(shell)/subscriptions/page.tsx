    ...
    return (
      <div className="page fade-in">
        ...
        <Card>
          <div className="empty">
            <span className="ico">
              <Icon name="subs" size={22} />
            </span>
            <h4>No subscriptions found yet</h4>
            <p>
              Sync an inbox to scan recent receipts and billing emails. Detected subscriptions will
  ...
  const stats = [
    {
      ...
      ic: "subs",
      delta: `${subs.length} detected`,
    },
    {
      l: "Monthly spend",
      v: monthly > 0 ? "$" + Math.round(monthly) : "—",
      ic: "receipt",
      delta: monthly > 0 ? "est. across active" : "no amounts detected",
    },
    {
      l: "Annualized",
      v: monthly > 0 ? "$" + Math.round(monthly * 12).toLocaleString() : "—",
      ic: "refresh",
      delta: "per year",
    },
    {
      ...
      v: String(review),
      ic: "flag",
      delta: "confirm to sharpen totals",
      warn: review > 0,
    },
  ]
      ...
      <div className="page-head">
        <div>
          ...
          <p className="page-sub">
            Recurring charges detected from receipts and billing emails. Confirm the uncertain ones
            to sharpen your totals.
          </p>
        </div>
      </div>
      ...
      <div className="grid" style={{ gridTemplateColumns: "repeat(4,1fr)", marginBottom: 16 }}>
        {stats.map((s) => (
          <Card key={s.l} className="stat">
            ...
            <span className="val" style={s.warn ? { color: "var(--st-warn)" } : {}}>
              {s.v}
            </span>
