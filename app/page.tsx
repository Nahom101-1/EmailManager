  ...
  return (
    <div className="home fade-in">
      ...
      <div className="home-wrap">
        <div>
          <Badge outline style={{ marginBottom: 22 }}>
            <Icon name="lock" size={12} />
            &nbsp;Local-first
          </Badge>
          <h1 className="home-promise">
            Map your digital life
            <br />
            from your <span className="hl">inbox</span>.
          </h1>
          <p className="home-lede">
            Connect your email and LifeOS surfaces the subscriptions, accounts, and recurring
            charges attached to your digital life — quietly, on your own machine.
          </p>
          ...
          <div className="home-trust">
            <Icon name="shield" size={14} /> Your data stays on your machine. Read-only access, no
            servers.
          </div>
        </div>
        ...
        <div className="preview-card">
          <div className="card-head" style={{ padding: "12px 16px" }}>
            <div className="center">
              <Icon name="dashboard" size={14} className="muted" />
              <span style={{ fontWeight: 650, fontSize: 13 }}>Dashboard preview</span>
            </div>
              ...
              {previewStats.map((s) => (
                <div key={s.l} className="card" style={{ padding: 13 }}>
                  <div className="stat" style={{ padding: 0, gap: 6 }}>
                    ...
                    <span className="val" style={{ fontSize: 21 }}>
                      {s.v}
                    </span>
                  </div>
                </div>
                ...
                {subs.slice(0, 3).map((s) => (
                  <div key={s.id} className="list-row" style={{ padding: "9px 13px" }}>
                    ...
                    {s.amount != null ? (
                      ...
                      <span className="badge idle" style={{ height: 18 }}>
                        {s.status}
                      </span>
                    )}
                  </div>
                ...
                {subs.length === 0 && (
                  <div className="list-row" style={{ padding: "12px 13px" }}>
                    <span className="row-sub">
                      Connect an inbox to see detected subscriptions here.
                    </span>
                  </div>
                )}
              </div>
