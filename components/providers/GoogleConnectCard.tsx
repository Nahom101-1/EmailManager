    ...
    >
      ...
      >
        <div className="center" style={{ gap: 14, alignItems: "flex-start" }}>
          ...
          <div>
            ...
            <p className="muted mt6" style={{ fontSize: 13, maxWidth: "52ch" }}>
              Use Google&apos;s consent screen — no password required. LifeOS requests{" "}
              <b style={{ color: "var(--ink)" }}>read-only</b> Gmail access through the Gmail API.
            </p>
            <div className="center gap12 mt10 wrap">
              <span className="center gap6 faint" style={{ fontSize: 11.5 }}>
        ...
        <div style={{ alignSelf: "center" }}>
          <a href="/api/google/connect" onClick={() => setRedirecting(true)}>
            <Btn
              variant="primary"
              icon={redirecting ? undefined : "connect"}
      ...
      {redirecting && (
        ...
        >
          ...
          <div className="body">
            Opening Google&apos;s consent screen. Approve <b>read-only Gmail</b> access to continue.
          </div>
        </div>
      )}
      {error && (
